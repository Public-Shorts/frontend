<div class="flex max-w-lg flex-col gap-4 text-gallery-400">
	<div>
	...
	<div>
		...
		the glass windows at <a
			class="text-gallery-700"
			href="https://maps.app.goo.gl/UKxpSPXeA9ud5hyWA">Kanapé</a
